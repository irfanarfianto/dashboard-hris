...
export default function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "flex h-screen w-64 flex-col border-r bg-gradient-to-b from-teal-50 via-cyan-50 to-lime-50 dark:from-teal-950/30 dark:via-cyan-950/20 dark:to-lime-950/20",
        className
      )}
    >
      {/* Logo/Brand */}
      <div className="flex h-16 items-center border-b px-6 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
                  ...
                  >
                    ...
                    <ChevronDown
                      className={cn(
                        ...
                        isAnySubmenuActive && "text-teal-600 dark:text-teal-400"
                      )}
                    />
                  </button>
