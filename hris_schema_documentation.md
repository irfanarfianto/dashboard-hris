...
```sql
-- ==============================================================================
-- 1. DEFINISI CUSTOM TYPES (ENUMS)
-- Diperlukan untuk kolom yang memiliki batasan nilai yang ketat (ENUM)
-- ==============================================================================
...
-- Tipe untuk Permintaan (Cuti/Dinas)
...
-- Tipe untuk Data Personel
CREATE TYPE marital_status_enum AS ENUM ('TK/0', 'K/0', 'K/1', 'K/2', 'K/3'); -- Status PTKP/Perkawinan
...
CREATE TABLE employee_shift_schedules (
    ...
    date DATE NOT NULL, -- Tanggal spesifik shift
    notes TEXT,
    ...
    -- Constraint: 1 employee, 1 tanggal = max 1 shift
...
CREATE TABLE users (
    id SERIAL PRIMARY KEY,
    auth_user_id UUID UNIQUE REFERENCES auth.users(id) ON DELETE CASCADE, -- ✅ TAMBAHAN
